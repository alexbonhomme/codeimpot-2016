...
if (d.name == "5"){d.end_value = d3.max(data_line, function(d) {return d.Revenus; })}
});
...
if (value_2 <0)
  {var si_negatif = " (    l'Etat rembourse "+ -value_2 + "€)"}
else {var si_negatif = ""}

d3.select("#block1 .taxes_before").html("<span>" + value_2 + "€</span>" + si_negatif);

d3.select("#block1 #bymonth").text("Soit " + Math.round(value_2/12) + "€ par mois");

d3.select("#innerblock1 .taxes_before").text((Math.round(10000*value_2/value_))/100 + "%");

var this_tranche = +bisectTranches(data_tranches, value_);

d3.select("#innerblock2 .taxes_before").text(this_tranche);
            ...
            return {
                ...
                link: function(scope, element, attrs) {
                    d3Service.d3().then(function (d3) {
                        ...
                        var data_tranches  =[
{"name":"1", "start_value":0, "end_value":40000},
{"name":"2", "start_value":40000, "end_value":70000},
{"name":"3", "start_value":70000, "end_value":100000},
{"name":"4", "start_value":100000, "end_value":130000},
{"name":"5", "start_value":130000}
];
