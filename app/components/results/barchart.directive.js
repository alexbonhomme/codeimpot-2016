...
.attr("y", 25)
.attr("x", margin_first_text + width_graph)
.text(function(d){if (d.typologie == "deduction"){var minus_sign = "-"}else{var minus_sign = ""};if (d.percentage){var this_percentage = " " + d.percentage}else{var this_percentage = ""}; return minus_sign + d.value + " € " + this_percentage;})
.attr("fill", function(d){return colorScale(d.typologie)});
